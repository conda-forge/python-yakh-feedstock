...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-yakh-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-yakh-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-yakh
# for installing globally
pixi global install python-yakh
```
...
It is possible to list all of the versions of `python-yakh` available on your platform:
...
```
pixi search python-yakh --channel conda-forge
```
